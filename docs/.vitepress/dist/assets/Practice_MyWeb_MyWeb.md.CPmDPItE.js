import{_ as a,c as n,o as p,ae as e}from"./chunks/framework.BjlC_BXf.js";const l="/assets/2.1.CjQ6c0B7.png",i="/assets/2.2.sQD0LuRk.png",t="/assets/2.3.DhtP-n-i.png",c="/assets/2.4.7yC_PnXu.png",o="/assets/4.2.Chg8HPnW.png",d="/assets/5.D4cd8m4N.png",r="/assets/6.1.CJi7_11i.png",h="/assets/6.2.Bfjk2HHT.png",f=JSON.parse('{"title":"手把手教你搭建属于自己的技术博客（基于VitePress）","description":"","frontmatter":{},"headers":[],"relativePath":"Practice/MyWeb/MyWeb.md","filePath":"Practice/MyWeb/MyWeb.md"}'),u={name:"Practice/MyWeb/MyWeb.md"};function g(b,s,m,v,k,_){return p(),n("div",null,s[0]||(s[0]=[e('<h1 id="手把手教你搭建属于自己的技术博客-基于vitepress" tabindex="-1">手把手教你搭建属于自己的技术博客（基于VitePress） <a class="header-anchor" href="#手把手教你搭建属于自己的技术博客-基于vitepress" aria-label="Permalink to &quot;手把手教你搭建属于自己的技术博客（基于VitePress）&quot;">​</a></h1><h2 id="_1-环境准备" tabindex="-1">1. 环境准备 <a class="header-anchor" href="#_1-环境准备" aria-label="Permalink to &quot;1. 环境准备&quot;">​</a></h2><p>安装node.js</p><p>node.js下载地址：<a href="https://nodejs.cn/download/" target="_blank" rel="noreferrer">https://nodejs.cn/download/</a>。 安装完成后，在终端输入指令：<code>node -v</code>，查看node.js版本。</p><h2 id="_2-创建项目" tabindex="-1">2.创建项目 <a class="header-anchor" href="#_2-创建项目" aria-label="Permalink to &quot;2.创建项目&quot;">​</a></h2><h3 id="_2-1-创建项目目录" tabindex="-1">2.1 创建项目目录 <a class="header-anchor" href="#_2-1-创建项目目录" aria-label="Permalink to &quot;2.1 创建项目目录&quot;">​</a></h3><p>在桌面新建一个文件夹（mytest）用于存放项目，打开该文件夹，在文件夹内点击右键打开终端</p><p><img src="'+l+'" alt=""></p><h3 id="_2-2-安装vitepress" tabindex="-1">2.2 安装VitePress <a class="header-anchor" href="#_2-2-安装vitepress" aria-label="Permalink to &quot;2.2 安装VitePress&quot;">​</a></h3><p>将VitePress安装到当前项目目录下，输入指令：<code>npm add -D vitepress</code>。 <img src="'+i+'" alt=""></p><h3 id="_2-3-初始化项目" tabindex="-1">2.3 初始化项目 <a class="header-anchor" href="#_2-3-初始化项目" aria-label="Permalink to &quot;2.3 初始化项目&quot;">​</a></h3><p>在终端输入指令：<code>npx vitepress init</code>，根据下图填写信息，回车即可。 <img src="'+t+'" alt=""></p><h3 id="_2-4-启动项目" tabindex="-1">2.4 启动项目 <a class="header-anchor" href="#_2-4-启动项目" aria-label="Permalink to &quot;2.4 启动项目&quot;">​</a></h3><p>在终端输入指令：<code>npm run docs:dev</code>，启动项目。在浏览器中输入：<code>localhost:5173</code>，如果显示正常，则说明项目创建成功。 <img src="'+c+`" alt=""></p><h2 id="_3-markdown基础语法" tabindex="-1">3. Markdown基础语法 <a class="header-anchor" href="#_3-markdown基础语法" aria-label="Permalink to &quot;3. Markdown基础语法&quot;">​</a></h2><p>加粗：<code>**加粗**</code></p><p>斜体：<code>*斜体*</code></p><p>换行：两个回车</p><p>标题：<code># 一级标题</code> <code>## 二级标题</code> <code>### 三级标题</code></p><p>引用：<code>&gt; 引用</code></p><p>列表：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>- 无序列表</span></span>
